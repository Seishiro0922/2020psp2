...
## ソースコードの説明
8~11  それぞれの県の平均と標準偏差を定義する。

37  A県の平均と分散を用いて標準化する

38　B県の平均と分散を用いて標準化する

39　40　それぞれの県の出現確率を求める

41　42　それぞれの求めた出現確率を総乗する
...
[comment #20200521]
- max_val, min_valという変数名はおそらく私のテンプレートをそのまま使ったのだと思いますが，きちんと意味の通る名前にしてください．今回の課題は最大とか最小ではないので．
- u1,b1などという名前も意味不明です．uはどういう意味ですか，プログラムの中では平均のようですが，uという名前は平均を連想させません．bも同様．
  - zはOKです．なぜかというと，このような演算（標準化）で求めたものをz値というからです．
- 関数の中で数値そのものを書かないこと
  今，
  ```
  int main()
  ...
  ```
  のように書いていますが，これは可読性から言ってNGです．関数は全て変数名で一般化させます．
  なので，
  ```
  #define MU_A 170.8
  int main()
